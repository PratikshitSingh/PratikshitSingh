...
**Email:** pratikshitsinghpanwar@gmail.com  
...
- I design **microservices** that stay up, stay fast, and stay readable.
- I turn messy data into usable systems (**EMR + PySpark** pipelines that chew through GBs).
- I build **GenAI** features with real-world constraints: **RAG**, agents, evaluation, and guardrails.
...
## A few things I’ve shipped (high signal)
...
## ⚡ Fun fact
I love problems where **correctness, performance, and maintainability** all matter at the same time—and I’m slightly obsessed with clean boundaries (Hexagonal / well-tested services).
